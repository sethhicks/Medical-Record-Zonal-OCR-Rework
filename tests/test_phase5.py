...
def test_single_results_sheet(tmp_path):
...
def test_cms1500_column_count(tmp_path):
    """Results sheet has exactly 3 columns (OUT-02)."""
    import openpyxl
    from pipeline import write_workbook
...
def test_ub04_column_count(tmp_path):
    """UB-04 date field (date_of_service_rl1) lands in column 3 of Results sheet (OUT-02)."""
    import openpyxl
    from pipeline import write_workbook
